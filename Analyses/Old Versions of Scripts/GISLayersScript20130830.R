...
### DEM MODEL PLOTS
with(Total.Pts, plot(DEM,Basal.Area, main="All Species"))
...
with(Total.Pts, plot(MarchRadiation,Basal.Area))
...
### July Max Temp Plots
with(Total.Pts, plot(TMaxJUL,Basal.Area))
...
with(Total.Pts, plot(tminJAN,Basal.Area))
...
with(Total.Pts, plot(WD,Basal.Area, main="All Species"))
with(Pts.QUEGAR, plot(WD,Basal.Area, main = "QUEGAR"))
with(Pts.QUEDOU, plot(WD,Basal.Area, main="QUEDOU"))
with(Pts.QUEKEL, plot(WD,Basal.Area, main="QUEKEL"))
with(Pts.QUEAGR, plot(WD,Basal.Area, main= "QUEAGR"))
with(Pts.PSEMEN, plot(WD,Basal.Area, main= "PSEMEN"))
with(Pts.AMOCAL, plot(WD,Basal.Area, main= "AMOCAL"))

###### WD LM
QUEGAR.WD.LM<-lm(Basal.Area~WD, data=Pts.QUEGAR)
summary(QUEGAR.WD.LM)  
plot(QUEGAR.WD.LM)

QUEDOU.WD.LM<-lm(Basal.Area~WD, data=Pts.QUEDOU)
summary(QUEDOU.WD.LM) 
plot(QUEDOU.WD.LM)

QUEAGR.WD.LM<-lm(Basal.Area~WD, data=Pts.QUEAGR)
summary(QUEAGR.WD.LM)

PSEMEN.WD.LM<-lm(Basal.Area~WD, data=Pts.PSEMEN)
summary(PSEMEN.WD.LM) 

QUEKEL.WD.LM<-lm(Basal.Area~WD, data=Pts.QUEKEL)
summary(QUEKEL.WD.LM)
plot((QUEKEL.WD.LM))


AMOCAL.WD.LM<-lm(Basal.Area~WD, data=Pts.AMOCAL)
summary(AMOCAL.WD.LM)

####### Total Biomass with Many Models --> Nothing significant
Sum.Pts<-with(Total.Pts, aggregate(Basal.Area~Plot.ID, FUN=sum))
head(Sum.Pts)
...
head(Sum.TMax.Pts)
with(Sum.TMax.Pts, plot(,Basal.Area))


### tpi500 MODEL PLOTS
with(Total.Pts, plot(tpi500,Basal.Area, main="All Species"))
...
QUEDOU.Multi<-lm(Basal.Area ~ tminJAN * TMaxJUL * WD, data=Pts.QUEDOU)
summary(QUEDOU.Multi)

QUEGAR.Multi<-lm(Basal.Area ~ tminJAN * TMaxJUL *WD, data=Pts.QUEGAR)
summary(QUEGAR.Multi)

QUEKEL.Multi<-lm(Basal.Area ~ tminJAN * TMaxJUL * WD, data=Pts.QUEKEL)
summary(QUEKEL.Multi)

QUEAGR.Multi<-lm(Basal.Area ~ tminJAN * TMaxJUL * WD, data=Pts.QUEAGR)
summary(QUEAGR.Multi)

PSEMEN.Multi<-lm(Basal.Area ~ tminJAN * TMaxJUL * WD, data=Pts.PSEMEN)
summary(PSEMEN.Multi)

AMOCAL.Multi<-lm(Basal.Area ~ tminJAN * TMaxJUL * WD, data=Pts.AMOCAL)
